...
struct Z_CompiledInDeferFile_FID_CPlus_Plugins_TestPlugin_Source_TestPlugin_Public_MidiEvent_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMidiEvent::StaticStruct, Z_Construct_UScriptStruct_FMidiEvent_Statics::NewStructOps, TEXT("MidiEvent"), &Z_Registration_Info_UScriptStruct_MidiEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMidiEvent), 185784245U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CPlus_Plugins_TestPlugin_Source_TestPlugin_Public_MidiEvent_h_3242757509(TEXT("/Script/TestPlugin"),
	nullptr, 0,
