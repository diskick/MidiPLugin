...
public class Midi_Library : ModuleRules
{
	public Midi_Library(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			PublicAdditionalLibraries.Add(Path.Combine(ModuleDirectory, "bin", "Midi.lib"));
